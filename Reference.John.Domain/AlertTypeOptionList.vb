...
Imports System.ComponentModel.DataAnnotations
	...
	<DebuggerDisplay("Models.AlertTypeOptionList: {AlertTypeId} {Name} {SortOrder}")>
Partial Public Class AlertTypeOptionList
...
<Display(resourceType:=GetType(Reference.John.Resources.Resources.Names), name:="LastChangeDate")>
    ...
    Public Overridable Property AlertTemplates As ICollection(Of AlertTemplate) = New HashSet(Of AlertTemplate)
