...
Namespace Areas.HelpPage
    ...
    Public Module HelpPageConfig
        <SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId:="Reference.John.WebAPI.Areas.HelpPage.TextSample.#ctor(System.String)",
        ...
        Public Sub Register(config As HttpConfiguration)
            ...
            config.SetDocumentationProvider(New XmlDocumentationProvider(HttpContext.Current.Server.MapPath("~/App_Data/Reference.John.UI.Model.xml")))
