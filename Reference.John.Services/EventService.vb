...
Public Class EventSesrvice
    ...
    Public Function ProcessEvents(actionType As Reference.John.Domain.ActionTypeOptionList, item As IEventEntity) As IEnumerable(Of Reference.John.Domain.FormAlertTemplate_xref) Implements IEventService.ProcessEvents
    ...
    Public Sub PublishAlerts() Implements IEventService.PublishEvents
