...
Namespace Resources
    ...
    Public Class LogMessages
        ...
        '''</summary>
        Public Shared ReadOnly Property ExecutingTask() As String
            Get
                Return ResourceManager.GetString("ExecutingTask", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  Looks up a localized string similar to Launched Background Tasks.
        '''</summary>
        Public Shared ReadOnly Property LaunchedBackgroundTasks() As String
            Get
                Return ResourceManager.GetString("LaunchedBackgroundTasks", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  Looks up a localized string similar to Launching Background Tasks.
        '''</summary>
        Public Shared ReadOnly Property LaunchingBackgroundTasks() As String
            Get
                Return ResourceManager.GetString("LaunchingBackgroundTasks", resourceCulture)
            End Get
        End Property
