...
Public Class FormContactZeroRepository
    ...
    Public Function NewlyCreated() As IList(Of Domain.FormSimpleZero) Implements IFormContactZeroRepository.NewlyCreated
        ...
        Return GetQuery(Of Domain.FormSimpleZero)().Where(Function(c) c.DateCreated >= lastMonth).ToList()
    End Function
    ...
    Public Function FindByName(firstname As String, lastname As String) As Domain.FormSimpleZero Implements IFormContactZeroRepository.FindByName
        Return GetQuery(Of Domain.FormSimpleZero)().Where(Function(c) c.FirstName = firstname AndAlso c.LastName = lastname).FirstOrDefault()
    End Function
End Class
